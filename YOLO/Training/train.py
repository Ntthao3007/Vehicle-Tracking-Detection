...
ap.add_argument("-tip", "--train_img_files_path", default="./data/bdd100k/images/100k/train", 
                help="path to the train image folder")
ap.add_argument("-ttp", "--train_target_files_path", 
                default="./data/bdd100k/labels/det_20/det_train.json", 
...
ap.add_argument("-ne", "--number_epochs", default=10, help="amount of epochs")
...
'''
example:
CUDA_VISIBLE_DEVICES=2 python3 ./Training/train.py 
'''